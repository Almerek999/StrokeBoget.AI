...
data_path = os.path.join(current_dir, "..", "input_data", "landmarks_dataset.csv")
...
model = models.Sequential([
    ...
    layers.Dropout(0.3), # Защита от "зубрежки" (увеличено)
...
model.save(os.path.join(models_dir, 'stroke_ai_model.h5'))
